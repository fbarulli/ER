...
from euromonitor.core.common import resolve_model as _resolve_model
...
def main() -> None:
    ...
    # eval pair caps from the SSOT pairs block (src/euromonitor/training/training.yaml) — were
