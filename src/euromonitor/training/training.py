"""src/euromonitor/training/training.py — solid GPU-ready fine-tune pipeline for the
second-series lane.
...
Usage:
  python src/euromonitor/training/train.py --loss contrastive     (entry; src/euromonitor/training/ is a package)
  python src/euromonitor/training/train.py --hpo --n-trials 20    # optuna TPE sweep
  python src/euromonitor/training/train.py --loss triplet --band 0.45-0.80
...
from euromonitor.core.common import SSOT_CONTRASTIVE_MARGIN as _SSOT_MARGIN
from euromonitor.core.common import runtime as _runtime

_SSOT_HP = bool(_runtime("hard_positives"))  # no-fallback SSOT
from euromonitor.core.hard_negatives import mine_hard_negatives, pairs_in_set
...
# TPE search space, SSOT: src/euromonitor/training/training.yaml hpo.tpe_space (validated by
...
from euromonitor.core.common import hpo_cfg as _hpo_cfg_load
...
def _dump_train_visibility(
    ...
    *,
    ...
    from euromonitor.core.common import write_visibility_log
...
def train_one_config(
    ...
    *,
    ...
    from euromonitor.core.schemas import TrainConfig as _TrainConfig
    ...
    from euromonitor.core.schemas import DataTuple as _DataTuple
    ...
    from euromonitor.core.common import band as _band_helper
    ...
    for fold_i, test_bc in enumerate(folds):
        try:
            ...
            if loss == "contrastive":
                ...
                from euromonitor.core.hard_negatives import build_triplets
            ...
            from euromonitor.core.common import load_config as _lc
            ...
            # population as pr_auc so those CSVs regenerate from src/euromonitor/training/train runs.
