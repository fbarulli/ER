...
from euromonitor.ner.ner_product_attributes import (
    Candidate,
...
from euromonitor.pipeline import clean_sku_text, normalize_text
from euromonitor.core.common import COLUMN_MAPPING, DATA_PATH, F, RESULTS
