...
from euromonitor.core.common import RESULTS, load_config, pair_auc
...
def rerank_stage(
    ...
    # max_length SSOT: training.rerank_max_length (src/euromonitor/training/training.yaml) —
    ...
    # module import (the importlib hack existed only because "src/euromonitor/training/train"
    # is not a legal module name)
    import euromonitor.training.train as mod
    ...
    from euromonitor.core.common import band as _band
    ...
    # (src/euromonitor/training/training.yaml) — the quantitative "clearly improve" criterion,
    # defined BEFORE looking at test results (was inline 0.005s).
    from euromonitor.core.common import rerank_cfg as _rerank_cfg
...
def _emit_four_pop(bi, payload, df, test_pos, test_neg, pos, neg) -> None:
    ...
    # Caps read from the SSOT pairs block (src/euromonitor/training/training.yaml
    ...
    from euromonitor.core.common import SEED
    from euromonitor.core.common import load_config as _lc_pairs
    ...
    from euromonitor.core.common import F
