...
Three sections (verbatim from the monorepo, adapted to this lane's lib/):
...
from euromonitor.core.blocking import build_true_pairs, eval_blocking
...
from euromonitor.core.text import extract_pack_counts, extract_volume_ml
...
# (src/euromonitor/training/training.yaml audit: block) via training_cfg — were inline
