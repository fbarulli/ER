...
from euromonitor.core.common import training_cfg
from euromonitor.core.schemas import MaskingResult

# extent band SSOT — read once at import from src/euromonitor/training/training.yaml (masking:
...
def mask_text(
    ...
    moved to the config values 0.20-0.35 in src/euromonitor/training/training.yaml).
...
def augment_positives(
    ...
    *,
    ...
    src/euromonitor/training/train + src/euromonitor/training/training — payload'/row_bc' stay length-locked and
