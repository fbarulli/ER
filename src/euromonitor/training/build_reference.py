...
its recipe lived only as functions in euromonitor.pipeline.py. This script is that
...
Usage:
  python src/euromonitor/training/build_reference.py            # (re)build the reference
  python src/euromonitor/training/build_reference.py --verify   # assert byte-equality vs
...
from euromonitor.pipeline import build_reference, census_texts, reference_path
from euromonitor.core.common import load_dataset
