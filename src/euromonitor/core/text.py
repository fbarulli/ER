...
# consumers — the live flavor signal is euromonitor.pipeline.FLAVOR_PATTERN (its own
...
# alongside code. Consumers: src/euromonitor/training/blocking_audit.py, src/euromonitor/training/report_plots.py,
