...
def build_triplets(
    ...
    *,
    ...
    defaults to training.max_triples (src/euromonitor/training/training.yaml) when None;
    explicit values still win (training.py passes per-fold seed offsets).
    No inline literals in this signature.
    """
    from euromonitor.core.common import SEED, runtime
...
def mine_hard_negatives(
    ...
    *,
    ...
    numeric default resolves from src/euromonitor/training/training.yaml when None — seed
    ...
    """
    from euromonitor.core.common import SEED, category_macros, training_cfg
