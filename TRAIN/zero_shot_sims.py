...
from lib.common import RESULTS, F, load_config, resolve_model
...
#   python TRAIN/zero_shot_sims.py --models minilm_l6,multilingual_l12
...
def main() -> None:
    ...
    from data_pipe import canonical_model_text, strip_schema_words
