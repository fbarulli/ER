...
from lib.common import RESULTS, load_config, pair_auc
...
def rerank_stage(
    ...
    # max_length SSOT: training.rerank_max_length (TRAIN/training.yaml) —
    ...
    # module import (the importlib hack existed only because "TRAIN/train"
    # is not a legal module name)
    import TRAIN.train as mod
    ...
    from lib.common import band as _band
    ...
    # (TRAIN/training.yaml) — the quantitative "clearly improve" criterion,
    # defined BEFORE looking at test results (was inline 0.005s).
    from lib.common import rerank_cfg as _rerank_cfg
...
def _emit_four_pop(bi, payload, df, test_pos, test_neg, pos, neg) -> None:
    ...
    # Caps read from the SSOT pairs block (TRAIN/training.yaml
    ...
    from lib.common import load_config as _lc_pairs
