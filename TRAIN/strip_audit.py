...
Stages (identical order + code paths as data_pipe.clean_sku_text — this
...
Usage:
  python TRAIN/strip_audit.py --gtin 747519482230        one SKU, full ladder
  python TRAIN/strip_audit.py --sample 200              random SKUs, summary
  python TRAIN/strip_audit.py --sample 200 --levels 8   + similarity ladder
...
def ladder(title: str, attribute: str = "", brand: str = "") -> dict:
    ...
    from data_pipe import spell_numeric_brand, strip_number_tokens
...
def main() -> None:
    ...
    # default sample SSOT: TRAIN/training.yaml audit.strip_audit_sample
    # (was inline 200, then EDA/eda.yaml strip_audit_sample)
    from lib.common import training_cfg as _training_cfg
