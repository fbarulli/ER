...
its recipe lived only as functions in data_pipe.py. This script is that
...
Usage:
  python TRAIN/build_reference.py            # (re)build the reference
  python TRAIN/build_reference.py --verify   # assert byte-equality vs
...
from data_pipe import build_reference, census_texts, reference_path
